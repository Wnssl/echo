...
class EchoData(Dataset):
    ...
    def __getitem__(self, item):
        ...
        tensor = normalize_frames(tensor)
        ...
        if self.pt == 'c' and self.train:
            ...
            return transform(tensor), target, weight
        else:
            return transform(tensor), target
...
if __name__ == '__main__':
    train = train_data('G:\\train_data_32_full\\')
    print(len(train))
    #     print(len(train))
    #     # print(train[3569])
